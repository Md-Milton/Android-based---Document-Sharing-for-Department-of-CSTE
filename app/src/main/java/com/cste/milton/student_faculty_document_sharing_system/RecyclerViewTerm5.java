...
public class RecyclerViewTerm5 extends AppCompatActivity {
    RecyclerView recyclerView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_recycler_view_term5);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(RecyclerViewTerm5.this));
        MyAdapter myAdapter = new MyAdapter(recyclerView,RecyclerViewTerm5.this,new ArrayList<String>(),new ArrayList<String>());
