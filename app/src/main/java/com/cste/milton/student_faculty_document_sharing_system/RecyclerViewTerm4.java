...
public class RecyclerViewTerm4 extends AppCompatActivity {
    RecyclerView recyclerView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_recycler_view_term4);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(RecyclerViewTerm4.this));
        MyAdapter myAdapter = new MyAdapter(recyclerView,RecyclerViewTerm4.this,new ArrayList<String>(),new ArrayList<String>());
