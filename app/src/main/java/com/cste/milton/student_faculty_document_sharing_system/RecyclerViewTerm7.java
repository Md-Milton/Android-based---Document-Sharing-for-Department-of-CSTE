...
public class RecyclerViewTerm7 extends AppCompatActivity {
    RecyclerView recyclerView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_recycler_view_term7);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(RecyclerViewTerm7.this));
        MyAdapter myAdapter = new MyAdapter(recyclerView,RecyclerViewTerm7.this,new ArrayList<String>(),new ArrayList<String>());
