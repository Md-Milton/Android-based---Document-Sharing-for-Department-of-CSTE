...
public class RecyclerViewTerm2 extends AppCompatActivity {
    RecyclerView recyclerView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_recycler_view_term2);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(RecyclerViewTerm2.this));
        MyAdapter myAdapter = new MyAdapter(recyclerView,RecyclerViewTerm2.this,new ArrayList<String>(),new ArrayList<String>());
