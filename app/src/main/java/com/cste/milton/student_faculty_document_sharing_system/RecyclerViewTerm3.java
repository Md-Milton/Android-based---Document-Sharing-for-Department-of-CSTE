...
public class RecyclerViewTerm3 extends AppCompatActivity {
    RecyclerView recyclerView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_recycler_view_term3);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(RecyclerViewTerm3.this));
        MyAdapter myAdapter = new MyAdapter(recyclerView,RecyclerViewTerm3.this,new ArrayList<String>(),new ArrayList<String>());
