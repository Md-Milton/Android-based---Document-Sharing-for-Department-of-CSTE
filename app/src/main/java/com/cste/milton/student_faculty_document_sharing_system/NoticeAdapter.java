...
public class NoticeAdapter extends RecyclerView.Adapter<NoticeAdapter.ViewHolder> {
    ...
    public NoticeAdapter(RecyclerView recyclerView, Context context, ArrayList<String> items, ArrayList<String> urls) {
    ...
    @Override
    public NoticeAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {//to crate view for recycler list item
