...
public class RecyclerViewTerm6 extends AppCompatActivity {
    RecyclerView recyclerView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_recycler_view_term6);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(RecyclerViewTerm6.this));
        MyAdapter myAdapter = new MyAdapter(recyclerView,RecyclerViewTerm6.this,new ArrayList<String>(),new ArrayList<String>());
